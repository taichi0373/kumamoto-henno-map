...
import io.github.taichi0373.kumamoto_henno_map.service.admin.AdminAgencyService;
...
public class AdminAgencyController {
    ...
    public ResponseEntity<ApiResponseDto<AdminPagedResponseDto<AgencyEntity>>> getAll(
        ...
        try {
            var result = adminAgencyService.getAll(page, size, agencyName, agencyId, agencyKana, phoneNumber, operatorId, keyword, sort, order);
