...
import io.github.taichi0373.kumamoto_henno_map.repository.dao.BenefitEligibilityDao;
...
public class AdminBenefitEligibilityService {
    ...
    public CsvImportResultDto importCsv(MultipartFile file) throws IOException {
        List<BenefitEligibilityEntity> toInsert = new ArrayList<>();
        ...
        toInsert.forEach(benefitEligibilityDao::insert);
