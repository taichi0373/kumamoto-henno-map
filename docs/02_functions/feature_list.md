...
| F061 | フィードバック送信 | ヘッダーのボタンからモーダルを開き、バグ報告・要望・その他のご意見をSlackに送信する |
...
**概要**: ヘッダーに常時表示される「ご意見・ご要望」ボタンからモーダルダイアログを開き、バグ報告・要望・その他のカテゴリで意見を送信する機能

**詳細仕様**:
- **アクセス**: 全画面共通のヘッダーに「ご意見・ご要望」ボタンを表示
- **認証**: 不要（未ログインユーザーも送信可）
- **入力項目**:
  - カテゴリ（必須）: バグ報告 / 要望 / その他
